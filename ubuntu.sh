...
wget https://cdimage.ubuntu.com/ubuntu-base/releases/22.04/release/ubuntu-base-22.04-base-${ARCHITECTURE}.tar.gz -q -O ubuntu.tar.gz 
...
printf "\x1b[38;5;214m[${time1}]\e[0m \x1b[38;5;83m[Installer thread/INFO]:\e[0m \x1b[38;5;87m Installing Chromium, please wait...\n"
proot -r $directory apt update
proot -r $directory apt install -y chromium-browser
printf "\x1b[38;5;214m[${time1}]\e[0m \x1b[38;5;83m[Installer thread/INFO]:\e[0m \x1b[38;5;87m Chromium has been successfully installed!\n"
...
command+=" HOME=/root"
command+=" PATH=/usr/local/sbin:/usr/local/bin:/bin:/usr/bin:/sbin:/usr/sbin:/usr/games:/usr/local/games:/usr/lib/chromium-browser/bin"
command+=" TERM=\$TERM"
